...
As we mentioned before, DCAT-AP is based on the Data Catalog Vocabulary (DCAT). Essentially, the main goal of DCAT-AP is to allow data sets explorations in a cross-portal environment by exchanging descriptions of data sets among data portals.\footnote{\href{DCAT Application Profile for Data Portals in Europe}{https://joinup.ec.europa.eu/release/dcat-application-profile-data-portals-europe-final}}
...
For the class \textit{Catalog} all properties were frequently used. However, \textit{dct:hasPart,dct:isPartOf, dcat:record, dct:rights }and\textit{ dct:spatial }were not used at all.
\begin{figure}[!h]
